...
*textserver* is a daemon to notify changes of text file via HTTP
long-polling. It enables Firefox to synchronize contents of textarea
or input element with an external file. You will be able to edit on
Firefox using external text editors.
...
You need <b>Ruby 1.8.7</b>. After cloning the repository, don't forget to do
...
==== Linux
- <b>inotify</b> (optional)

==== Windows
- <b>rubygems</b> (required)
- <b>win32/api</b> (required)
- <b>win32/process</b> (required)
- <b>win32/ipc</b> (optional)
- <b>win32/event</b> (optional)
- <b>win32/changenotify</b> (optional)

== Build installer on Windows

If you have all applications listed below, you can
build the installer by the following command.
...
If you are using emacs, try <tt>elisp/textarea.el</tt>. Put this file
some where in your load path and write the following code to your
<tt>.emacs</tt>.
...
content of the current textarea on the browser.
